...
from .views import home_view, proyectos_view, sobre_mi_view, contacto_view, galerias_view, cuadro_detail_view
...
urlpatterns = [
    ...
    path('cuadro/<id>/', cuadro_detail_view, name='cuadro-view'),
